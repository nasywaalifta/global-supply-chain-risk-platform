...
<div class="container-fluid">
    <div class="d-flex justify-content-between align-items-center mb-4">
        <div>
            ...
            <p class="text-muted mb-0">Publikasikan insight, riset, atau berita terkait logistik & risiko supply chain.</p>
        </div>
                ...
                <div class="row g-3">
                    <div class="col-md-8">
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control rounded-3 @error('title') is-invalid @enderror" id="title" name="title" value="{{ old('title') }}" required placeholder="Masukkan judul artikel..." style="height: 48px;">
                            @error('title')
                        ...
                        <div class="mb-3">
                            ...
                            <textarea class="form-control rounded-3 @error('summary') is-invalid @enderror" id="summary" name="summary" rows="3" placeholder="Tulis ringkasan singkat artikel..." required>{{ old('summary') }}</textarea>
                            @error('summary')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
                        ...
                        <div class="mb-3">
                            ...
                            <textarea class="form-control rounded-3 @error('content') is-invalid @enderror" id="content" name="content" rows="12" placeholder="Tulis isi lengkap artikel di sini..." required style="font-family: inherit;">{{ old('content') }}</textarea>
                            @error('content')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
                    ...
                    <div class="col-md-4">
                        ...
                        <div class="card bg-light border-0 p-3 rounded-3">
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control rounded-3 @error('thumbnail') is-invalid @enderror" id="thumbnail" name="thumbnail" value="{{ old('thumbnail') }}" placeholder="https://images.unsplash.com/..." style="height: 48px;">
